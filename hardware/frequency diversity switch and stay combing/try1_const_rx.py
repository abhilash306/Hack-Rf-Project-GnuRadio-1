...
import osmosdr
import time
import try1_const_rx_epy_block_0_0_0 as epy_block_0_0_0  # embedded python block
...
class try1_const_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._noise_range = Range(0, 5, 0.01, 0.001, 200)
        ...
        self.qtgui_number_sink_0_0_1.set_title('FREQUENCY 50KHz')
        ...
        for i in range(1):
            ...
            self.qtgui_number_sink_0_0_1.set_max(i, 30)
        ...
        self.qtgui_number_sink_0_0_0_0.set_title('selected snr')
        ...
        self.qtgui_number_sink_0_0_0.set_title('FREQUENCY 100KHz SNR')
        ...
        self.epy_block_0_0_0 = epy_block_0_0_0.blk(threshold=8)
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 50e3, 1, 0, 0)
        ...
        self.connect((self.channels_channel_model_0, 0), (self.epy_block_0_0_0, 0))
        self.connect((self.channels_channel_model_1, 0), (self.digital_probe_mpsk_snr_est_c_0_0, 0))
        self.connect((self.channels_channel_model_1, 0), (self.epy_block_0_0_0, 1))
        self.connect((self.epy_block_0_0_0, 0), (self.digital_probe_mpsk_snr_est_c_0_1_0, 0))
        self.connect((self.epy_block_1_0_0, 0), (self.epy_block_0_0_0, 2))
        self.connect((self.epy_block_1_0_0, 0), (self.qtgui_number_sink_0_0_0, 0))
        self.connect((self.epy_block_1_0_1, 0), (self.epy_block_0_0_0, 3))
        self.connect((self.epy_block_1_0_1, 0), (self.qtgui_number_sink_0_0_1, 0))
        self.connect((self.epy_block_1_0_2, 0), (self.qtgui_number_sink_0_0_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.channels_channel_model_0, 0))
        self.connect((self.low_pass_filter_0_0, 0), (self.channels_channel_model_1, 0))
    ...
    def set_noise_0(self, noise_0):
        ...
        self.channels_channel_model_1.set_noise_voltage(self.noise_0)
