...
import siso_epy_block_1_0 as epy_block_1_0  # embedded python block



from gnuradio import qtgui

class siso(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "siso")
        ...
        self._noise_win = GrRangeWidget(self._noise_range, self.set_noise, "noise of channel", "counter_slider", float, QtCore.Qt.Horizontal, "value")
        ...
        self.connect((self.channels_channel_model_0_1, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
...
def main(top_block_cls=siso, options=None):
