...
import osmosdr
import time
import spatialdiver_sdr_rx_epy_block_1_0 as epy_block_1_0  # embedded python block
import spatialdiver_sdr_rx_epy_block_1_0_0 as epy_block_1_0_0  # embedded python block



from gnuradio import qtgui

class spatialdiver_sdr_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "spatialdiver_sdr_rx")
        ...
        self.qtgui_number_sink_0_0_0.set_title('osmosource output')
        ...
        self.osmosdr_source_0_0.set_center_freq(600e6, 0)
        ...
        self.osmosdr_source_0_0.set_bandwidth(5e6, 0)
        ...
        self.msg_connect((self.digital_probe_mpsk_snr_est_c_0_0, 'snr'), (self.epy_block_1_0_0, 'snr'))
        ...
        self.connect((self.digital_symbol_sync_xx_1, 0), (self.digital_probe_mpsk_snr_est_c_0, 0))
        ...
        self.connect((self.osmosdr_source_0_0, 0), (self.digital_probe_mpsk_snr_est_c_0_0, 0))
...
def main(top_block_cls=spatialdiver_sdr_rx, options=None):
