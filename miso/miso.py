...
import miso_epy_block_1_0_0 as epy_block_1_0_0  # embedded python block



from gnuradio import qtgui

class miso(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "miso")
        ...
        self._noise_0_range = Range(0, 5, 0.0001, 0.00, 200)
        ...
        self._noise_range = Range(0, 5, 0.01, 0.1, 200)
        self._noise_win = GrRangeWidget(self._noise_range, self.set_noise, "noise of channel 1", "counter_slider", float, QtCore.Qt.Horizontal, "value")
        ...
        for i in range(1):
            ...
            self.qtgui_number_sink_0_0.set_max(i, 30)
        ...
        self.connect((self.channels_channel_model_0_0_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.channels_channel_model_0_1, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.digital_constellation_modulator_0, 0), (self.channels_channel_model_0_0_0, 0))
        self.connect((self.digital_constellation_modulator_0, 0), (self.channels_channel_model_0_1, 0))
        ...
        self.connect((self.digital_symbol_sync_xx_1, 0), (self.digital_probe_mpsk_snr_est_c_0_1, 0))
        self.connect((self.digital_symbol_sync_xx_1, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.epy_block_1_0_0, 0), (self.qtgui_number_sink_0_0, 0))
    ...
    def set_noise(self, noise):
        self.noise = noise
        self.channels_channel_model_0_1.set_noise_voltage(self.noise)
...
def main(top_block_cls=miso, options=None):
