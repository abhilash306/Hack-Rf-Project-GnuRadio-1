...
import origfreqdiver_epy_block_0_0 as epy_block_0_0  # embedded python block
import origfreqdiver_epy_block_1 as epy_block_1  # embedded python block
import origfreqdiver_epy_block_1_0 as epy_block_1_0  # embedded python block
import origfreqdiver_epy_block_1_0_0 as epy_block_1_0_0  # embedded python block



from gnuradio import qtgui

class origfreqdiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "origfreqdiver")
        ...
        self.variable_constellation_0_0_0 = variable_constellation_0_0_0 = digital.constellation_qpsk().base()
        self.variable_constellation_0_0 = variable_constellation_0_0 = digital.constellation_qpsk().base()
        self.variable_adaptive_algorithm_0 = variable_adaptive_algorithm_0 = digital.adaptive_algorithm_lms( variable_constellation_rect_0, .0001).base()
        self.timing_loop_bw = timing_loop_bw = 6.28/100.0
        self.taps = taps = [1.0, 0.25-0.25j, 0.50 + 0.10j, -0.3 + 0.2j]
        self.samp_rate = samp_rate = 50000
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(nfilts, nfilts, 1.0/float(sps), 0.35, 11*sps*nfilts)
        self.phase_bw = phase_bw = 6.28/100.0
        self.noise_0 = noise_0 = 0.001
        self.noise = noise = 0.01
        self.freq2 = freq2 = 50000
        ...
        self._noise_0_range = Range(0, 5, 0.0001, 0.001, 200)
        self._noise_0_win = GrRangeWidget(self._noise_0_range, self.set_noise_0, "noise of channel 2", "counter_slider", float, QtCore.Qt.Horizontal, "value")

        self.top_layout.addWidget(self._noise_0_win)
        self._noise_range = Range(0, 5, 0.01, 0.01, 200)
        self._noise_win = GrRangeWidget(self._noise_range, self.set_noise, "noise of channel1", "counter_slider", float, QtCore.Qt.Horizontal, "value")
        ...
        self.qtgui_number_sink_1.set_title('selected snr after comparater')
        ...
        for i in range(1):
            ...
            self.qtgui_number_sink_1.set_max(i, 30)
        ...
        self.qtgui_number_sink_0.set_title("channel 2 snr")
        ...
        self.qtgui_number_sink.set_title('channel1 snr')
        ...
        for i in range(1):
            ...
            self.qtgui_number_sink.set_max(i, 30)
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(2, 0.0628, rrc_taps, 32, 16, 1.5, 1)
        ...
        self.blocks_complex_to_interleaved_char_1 = blocks.complex_to_interleaved_char(False, 1.0)
        self.blocks_complex_to_interleaved_char_0 = blocks.complex_to_interleaved_char(False, 1.0)
        self.analog_sig_source_x_2_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, freq2, 1, 0, 0)
        self.analog_sig_source_x_2 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, freq1, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, freq2, 1, 0, 0)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.digital_probe_mpsk_snr_est_c_0, 'snr'), (self.epy_block_1_0, 'snr'))
        self.msg_connect((self.digital_probe_mpsk_snr_est_c_0_0, 'snr'), (self.epy_block_1, 'snr'))
        self.msg_connect((self.digital_probe_mpsk_snr_est_c_0_1, 'snr'), (self.epy_block_1_0_0, 'snr'))
        ...
        self.connect((self.analog_sig_source_x_2_0, 0), (self.blocks_multiply_xx_1_0, 1))
        self.connect((self.blocks_complex_to_interleaved_char_0, 0), (self.fec_ber_bf_0, 0))
        self.connect((self.blocks_complex_to_interleaved_char_1, 0), (self.fec_ber_bf_0, 1))
        self.connect((self.blocks_multiply_xx_0, 0), (self.channels_channel_model_0_0, 0))
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.channels_channel_model_0_0_0, 0))
        ...
        self.connect((self.channels_channel_model_0_0, 0), (self.blocks_multiply_xx_1, 0))
        self.connect((self.channels_channel_model_0_0_0, 0), (self.blocks_multiply_xx_1_0, 0))
        self.connect((self.digital_constellation_modulator_0, 0), (self.blocks_complex_to_interleaved_char_0, 0))
        ...
        self.connect((self.digital_costas_loop_cc_0, 0), (self.digital_symbol_sync_xx_1, 0))
        self.connect((self.digital_linear_equalizer_0, 0), (self.digital_costas_loop_cc_0, 0))
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.digital_linear_equalizer_0, 0))
        self.connect((self.digital_symbol_sync_xx_1, 0), (self.blocks_complex_to_interleaved_char_1, 0))
        ...
        self.connect((self.epy_block_0_0, 0), (self.digital_probe_mpsk_snr_est_c_0_1, 0))
        self.connect((self.epy_block_1, 0), (self.epy_block_0_0, 3))
        self.connect((self.epy_block_1, 0), (self.qtgui_number_sink_0, 0))
        self.connect((self.epy_block_1_0, 0), (self.epy_block_0_0, 2))
        self.connect((self.epy_block_1_0, 0), (self.qtgui_number_sink, 0))
        self.connect((self.epy_block_1_0_0, 0), (self.qtgui_number_sink_1, 0))
        self.connect((self.fec_ber_bf_0, 0), (self.qtgui_number_sink_1_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.digital_probe_mpsk_snr_est_c_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.epy_block_0_0, 1))
        self.connect((self.low_pass_filter_1, 0), (self.digital_probe_mpsk_snr_est_c_0, 0))
        self.connect((self.low_pass_filter_1, 0), (self.epy_block_0_0, 0))
    ...
    def get_variable_constellation_0_0_0(self):
        return self.variable_constellation_0_0_0

    def set_variable_constellation_0_0_0(self, variable_constellation_0_0_0):
        self.variable_constellation_0_0_0 = variable_constellation_0_0_0
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, (self.freq2/5), 5000, window.WIN_RECTANGULAR, 6.76))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, (self.freq1/10), 5000, window.WIN_RECTANGULAR, 6.76))
    ...
    def set_noise_0(self, noise_0):
        ...
        self.channels_channel_model_0_0_0.set_noise_voltage(self.noise_0)
    ...
    def set_freq2(self, freq2):
        ...
        self.analog_sig_source_x_2_0.set_frequency(self.freq2)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, (self.freq2/5), 5000, window.WIN_RECTANGULAR, 6.76))
    ...
    def set_freq1(self, freq1):
        ...
        self.analog_sig_source_x_2.set_frequency(self.freq1)
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, (self.freq1/10), 5000, window.WIN_RECTANGULAR, 6.76))
...
def main(top_block_cls=origfreqdiver, options=None):
