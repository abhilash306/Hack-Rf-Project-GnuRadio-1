...
import origfreqdiver_epy_block_0_0_0 as epy_block_0_0_0  # embedded python block
...
class origfreqdiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._noise_0_range = Range(0, 5, 0.0001, 0.1, 200)
        ...
        self._noise_range = Range(0, 5, 0.0001, 0.001, 200)
        ...
        self.qtgui_number_sink_1.set_title('selected snr')
        ...
        self.epy_block_0_0_0 = epy_block_0_0_0.blk(threshold=5)
        ...
        self.connect((self.epy_block_0_0_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
        self.connect((self.epy_block_0_0_0, 0), (self.digital_probe_mpsk_snr_est_c_0_1, 0))
        self.connect((self.epy_block_1, 0), (self.epy_block_0_0_0, 3))
        self.connect((self.epy_block_1, 0), (self.qtgui_number_sink_0, 0))
        self.connect((self.epy_block_1_0, 0), (self.epy_block_0_0_0, 2))
        ...
        self.connect((self.low_pass_filter_0, 0), (self.epy_block_0_0_0, 1))
